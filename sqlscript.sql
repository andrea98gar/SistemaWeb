...
CREATE TABLE USUARIOS(Usuario VARCHAR(30) PRIMARY KEY, Contrasena LONGTEXT NOT NULL,  Nombre VARCHAR(30), Apellidos VARCHAR(30), DNI VARCHAR(9), Tel VARCHAR(9), Fecha VARCHAR(10), email VARCHAR(30));
